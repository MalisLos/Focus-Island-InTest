...
COMPUTER_MODE_THRESHOLDS = {
    ...
    'roll_range': (-15.0, 15.0),        # Roll angle range
...
DESK_MODE_THRESHOLDS = {
    ...
    'pitch_range': (-45.0, -25.0),      # Significant head-down range
    'yaw_range': (-25.0, 25.0),         # Small left-right rotation
    'roll_range': (-15.0, 15.0),        # Head tilt range
